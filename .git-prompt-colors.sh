...
override_git_prompt_colors() {
    ...
    ## e.g.
    ## GIT_PROMPT_COMMAND_OK="${Green}✔-_LAST_COMMAND_STATE_ "    # indicator if the last command returned with an exit$
    ## GIT_PROMPT_COMMAND_FAIL="${Red}✘-_LAST_COMMAND_STATE_ "    # indicator if the last command returned with an exit$

    GIT_PROMPT_COMMAND_OK="\n${Green}✔${ResetColor}"    # indicator if the last command returned with an exit code of 0
    GIT_PROMPT_COMMAND_FAIL="\n${Red}✘-_LAST_COMMAND_STATE_"    # indicator if the last command returned with an exit c$
